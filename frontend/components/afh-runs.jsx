          ...
          {step && (
            <div style={{ }}>
              ...
              <div style={{ marginTop: 16 }}>
                ...
                {activeTab === 'diff' && step.diff && <DiffViewer before={step.diff.before} after={step.diff.after} />}
                {activeTab === 'tests' && step.testResults && <TestPanel results={step.testResults} />}
                {activeTab === 'context' && step.collectorBreakdown && <ContextViewer breakdown={step.collectorBreakdown} />}
              </div>
            </div>
          )}
        </div>
